...
skill_score_summary = df_exploded.groupBy("Skill").agg(_sum("SCORE").alias("Total_Score")).orderBy(col("Total_Score").desc())

# 查看前几行结果
skill_score_summary.show(truncate=False)
```
